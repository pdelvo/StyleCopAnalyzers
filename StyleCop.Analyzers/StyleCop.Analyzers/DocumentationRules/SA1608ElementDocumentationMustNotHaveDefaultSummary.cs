namespace StyleCop.Analyzers.DocumentationRules
{
    ...
    public class SA1608ElementDocumentationMustNotHaveDefaultSummary : StyleCopDiagnosticAnalyzer
    {
        /// <summary>
        ...
        {
            this.RegisterSyntaxNodeActionHonorExclusions(context, this.HandleDocumentation, SyntaxKind.SingleLineDocumentationCommentTrivia, SyntaxKind.MultiLineDocumentationCommentTrivia);
        }
